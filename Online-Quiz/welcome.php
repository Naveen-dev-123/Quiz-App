...
<head>
    ...
    <style>
        body{
            background-image: url('https://swall.teahub.io/photos/small/239-2398171_hd-desktop-plain-images-hd-desktop-wallpapers-cool.jpg');
...
<body>
    <nav class="navbar navbar-default title1">
        ...
        <a class="navbar-brand" href=""><b> <span style="color:red;">Quiz</span></b></a>
        </div>
        ...
        <ul class="nav navbar-nav navbar-left">
            ...
            <li <?php if(@$_GET['q']==2) echo'class="active"'; ?>> <a href="welcome.php?q=2"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>&nbsp;Result</a></li>
